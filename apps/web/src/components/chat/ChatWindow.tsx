...
export function ChatWindow({ userId }: Props) {
  const { activeConversation, messages, conversations, onlineUsers } = useChatStore();
  ...
  if (!activeConversation) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-black/60 backdrop-blur-xl">
